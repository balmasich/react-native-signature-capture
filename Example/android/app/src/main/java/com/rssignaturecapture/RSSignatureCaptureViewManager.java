...
public class RSSignatureCaptureViewManager extends ViewGroupManager<RSSignatureCaptureMainView> {
	...
	@ReactProp(name = "enableDate")
	public void setEnableDate(RSSignatureCaptureMainView view, @Nullable boolean enableDate) {
		Log.d("enableDate:",  ""+enableDate);
		if(view!=null){
			view.getSignatureView().setEnableDate(enableDate);
		}
	}
